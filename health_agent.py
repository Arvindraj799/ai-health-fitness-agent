...
def main():
    ...
    if not gemini_api_key:
        ...
        st.info("Please set up the GEMINI_API_KEY in your environment variables or Streamlit secrets.")
        return

    if gemini_api_key:
        try:
            gemini_model = Gemini(id="gemini-2.5-flash-lite", api_key=gemini_api_key)
